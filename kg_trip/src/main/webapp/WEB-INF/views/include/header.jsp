...
<body class="d-body">
   <div class="container">
      <header style="box-shadow: 1px 1px #e9e9e9; margin-bottom: 70px;">
         <div class="headerWrap">
            <div class="topHead">
               <div class="logo"><img alt="이미지" src="/img/logo.png" width="200px"></div>
               <div class="test">
                 <!--  <div class="search">
                  ...
                  <ul class="user">
                     ...
                     <c:if
                        ...
                        <li class="font_small">${loginPublicInfo.m_nickname } 님 </li>
                        <li class="font_small"><a href='/Traveler/myPage'>마이페이지</a></li>
                        <li><button class="btn03" id="logoutBtn">로그아웃</button></li>
                     </c:if>
                     <c:if
                        test="${loginPublicInfo.m_auth == 'admin'}">
                        <li class="font_small">${loginPublicInfo.m_nickname } 님 </li>
                        <li class="font_small"><a href='/Admin/adminPage'>관리자 페이지</a></li>
                        <li><button class="btn03" id="logoutBtn">로그아웃</button></li>
                     </c:if>
                     <c:if
                        test="${not empty loginCorpInfo }">
                        <li class="font_small">${loginCorpInfo.c_name } 님 </li>
                        <li class="font_small"><a href='/Partner/corpPage'>기업 페이지</a></li>
                        <li><button class="btn03" id="logoutBtn">로그아웃</button></li>
                     </c:if>
                  </ul>
               </div>
            ...
            <div class="bottomHead" >
               <nav>
                  ...
                  <ul class="main_menubar">
                     ...
                     <li class="menu5"><a href='/pakage/P_pakageMain'>패키지</a>
                        <ul class="menu5_submenu">
                           <li><a href='/pakage/P_allList'>전체패키지</a>
                        </ul>
                     </li>   
