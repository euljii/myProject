						...
						<div class="public_account_inner" style="display: flex; flex-direction: column; align-items: center">
							<div class="Profile">
								...
								<label for="file" style=" z-index: 5; position: relative; left: 70px; top: -40px;">
									<div class="btn-upload">
										<img alt="수정" src="/img/camera2.png" style="overflow: hidden; border: 1px solid; border-radius: 10px; position: relative;">
									</div>
								</label>
							...
							<form id="public_account">
								<table class="infotable">
									<tr>
										<td class="obj" style="border-top-right-radius: 3px; border-top-left-radius: 3px;">
											<input type="hidden" value="${loginPublicInfo.m_idx }" name="m_idx" id="m_idx">
											아이디 
											</td>
										<td colspan="2">${loginPublicInfo.m_id } 
										</td>
									<tr>
									<tr>
										<td class="obj">닉네임 
									...
									<tr>
										<td class="obj" style="border-bottom-left-radius: 3px; border-bottom-right-radius: 3px;">전화번호 </td>
				...
				success : function(data) {
					...
					if (data == 1) {
							...
							if(m_nickname_upda == ""){
								...
								$("#nickname_check").css("color","#41d4b8");
							}
						}
				}, error : function() {
						console.log("실패2");
